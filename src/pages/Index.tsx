          ...
          <Card className="p-6 backdrop-blur-sm bg-white/80 dark:bg-gray-800/80 shadow-lg">
            <div className="space-y-4">
              <div className="relative">
                <Textarea placeholder="Share your thoughts or upload a document..." className="min-h-[200px] resize-none text-lg p-4" value={input} onChange={e => setInput(e.target.value)} />
              </div>

              <Button className="w-full" onClick={generateInsight} disabled={isLoading}>
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm text-muted-foreground">Upload a PDF, Word doc, or Text file</p>
              </div>
            </div>
          </Card>

          <AnimatePresence mode="wait">
            {insight && <motion.div initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
